  ...
  function handleSubmit() {
    ...
    if (country === "JP") {
      ...
      dataArr.forEach(function (row, array) {
        ...
        console.log((parseFloat(row[getI('N')]) / parseFloat(row[getI('G')])).toFixed(2),
          row[getI('N')], parseFloat(row[getI('N')]),
          row[getI('G')], parseFloat(row[getI('G')]));
        const yymmdd = row[getI('A')].split(" ")[0].split("/").join("");
        ...
        wsData['bill'].push([
          ...
          { t: "n", f: "ROUND(I" + (cnt + 1).toString() + "*P" + (cnt + 1).toString() + ",2)" },
          '',
          '',
          ''
        ]);
        ...
        const foreignCurrency = [
          parseFloat(row[27]) - parseFloat(row[getI('O')]),
        ...
        wsData['certificate'].push([
          yymmdd,
          cnt.toString().padStart(3, '0'),
          'Amazon' + yymmdd + '30' + cnt.toString().padStart(2, '0'),
          'Y1',
          'SUP00038',
          'Amazon.co.jp',
          { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 1).toString() + "*I" + ((cnt - 1) * 4 + 1 + 1).toString() + ",2)" },
          row[getI('N')],
          '',
          '',
          ...
          'SUP00038',
          'Amazon.co.jp',
          { t: "n", f: "ROUND(Q" + ((cnt - 1) * 4 + 1 + 1).toString() + "*R" + ((cnt - 1) * 4 + 1 + 1).toString() + ",2)" },
          '',
        ...
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '30' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00038', 'Amazon.co.jp', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 2).toString() + "*I" + ((cnt - 1) * 4 + 1 + 2).toString() + ",2)" }, row[getI('N')], '', '',
          '3', //diff. from this line
          '611801',
          '42527250',
          'Amazon Japan GK',
          { t: "n", f: "ROUND(Q" + ((cnt - 1) * 4 + 1 + 2).toString() + "*R" + ((cnt - 1) * 4 + 1 + 2).toString() + ",2)" },
          '',
          foreignCurrency[1].toFixed(2),
          '', '', row[getI('D')] + " " + productInfo[country][row[getI('E')]].name
        ]);
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '30' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00038', 'Amazon.co.jp', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 3).toString() + "*I" + ((cnt - 1) * 4 + 1 + 3).toString() + ",2)" }, row[getI('N')], '', '',
          '3', //diff. from this line
          '6115',
          '42527250',
          'Amazon Japan GK',
          { t: "n", f: "ROUND(Q" + ((cnt - 1) * 4 + 1 + 3).toString() + "*R" + ((cnt - 1) * 4 + 1 + 3).toString() + ",2)" },
          '',
          foreignCurrency[2].toFixed(2),
          '', '', row[getI('D')] + " " + productInfo[country][row[getI('E')]].name
        ]);
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '30' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00038', 'Amazon.co.jp', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 4).toString() + "*I" + ((cnt - 1) * 4 + 1 + 4).toString() + ",2)" }, row[getI('N')], '', '',
          '4', //diff. from this line
          '4111',
          'SUP00038',
          'Amazon.co.jp',
          '',
          { t: "n", f: "ROUND(Q" + ((cnt - 1) * 4 + 1 + 4).toString() + "*R" + ((cnt - 1) * 4 + 1 + 4).toString() + ",2)" },
      ...
      dataArr.forEach(function (row, array) {
        ...
        const yymmdd = sub[2] + months[sub[0]] + sub[1].split(",")[0];
        ...
        wsData['certificate'].push([
          yymmdd,
          cnt.toString().padStart(3, '0'),
          'Amazon' + yymmdd + '00' + cnt.toString().padStart(2, '0'),
          'Y1',
          'SUP00022',
          'Amazon.com',
          { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 1).toString() + "*I" + ((cnt - 1) * 4 + 1 + 1).toString() + ",2)" },
        ...
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '00' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00022', 'Amazon.com', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 2).toString() + "*I" + ((cnt - 1) * 4 + 1 + 2).toString() + ",2)" }, row[getI('O')], '', '',
          '3', //diff. from this line
          '611801',
          '76315326',
        ...
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '00' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00022', 'Amazon.com', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 3).toString() + "*I" + ((cnt - 1) * 4 + 1 + 3).toString() + ",2)" }, row[getI('O')], '', '',
          '3', //diff. from this line
          '6115',
          '76315326',
          'Amazon.com Services LLC',
        ...
        wsData['certificate'].push([yymmdd, cnt.toString().padStart(3, '0'), 'Amazon' + yymmdd + '00' + cnt.toString().padStart(2, '0'), 'Y1', 'SUP00022', 'Amazon.com', { t: "n", f: "ROUND(H" + ((cnt - 1) * 4 + 1 + 4).toString() + "*I" + ((cnt - 1) * 4 + 1 + 4).toString() + ",2)" }, row[getI('O')], '', '',
          '4', //diff. from this line
          '4111',
          'SUP00022',
          'Amazon.com',
